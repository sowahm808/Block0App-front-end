...
@Component({
  ...
  template: `<b0-page-header title="Scenario Review" description="Production component for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Scenario Review content"><pre>{{ state.data | json }}</pre></section> }
  }`,
