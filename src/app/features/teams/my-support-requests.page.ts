...
@Component({
  ...
  template: `<b0-page-header title="My Support Requests" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="My Support Requests content"><pre>{{ state.data | json }}</pre></section> }
  }`,
