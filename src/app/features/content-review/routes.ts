...
export default [
  { path: 'import-learning-pack', data: { ...data, title: 'Import learning pack', apiPath: '/admin/content/import-learning-pack', permissions: ['content.import'] }, canActivate: [permissionGuard], loadComponent: () => import('../admin/pages/import-learning-pack.page').then(m => m.ImportLearningPackPage) },
