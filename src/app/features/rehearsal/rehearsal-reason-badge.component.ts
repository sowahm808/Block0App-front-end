...
@Component({
  ...
  template: `<b0-page-header title="Rehearsal Reason Badge" description="Production component for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Rehearsal Reason Badge content"><pre>{{ state.data | json }}</pre></section> }
  }`,
