...
@Component({
  ...
  template: `<b0-page-header title="Rehearsal Session" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Rehearsal Session content"><pre>{{ state.data | json }}</pre></section> }
  }`,
