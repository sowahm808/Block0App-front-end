...
@Component({
  ...
  template: `<b0-page-header title="Rehearsal Summary" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Rehearsal Summary content"><pre>{{ state.data | json }}</pre></section> }
  }`,
