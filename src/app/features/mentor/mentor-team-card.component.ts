...
@Component({
  ...
  template: `<b0-page-header title="Mentor Team Card" description="Production component for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Mentor Team Card content"><pre>{{ state.data | json }}</pre></section> }
  }`,
