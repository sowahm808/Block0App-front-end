...
@Component({
  ...
  template: `<b0-page-header title="Mentor Teams" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Mentor Teams content"><pre>{{ state.data | json }}</pre></section> }
  }`,
