...
@Component({
  ...
  template: `<b0-page-header title="Today Challenge" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Today Challenge content"><pre>{{ state.data | json }}</pre></section> }
  }`,
