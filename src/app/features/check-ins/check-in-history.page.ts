...
@Component({
  ...
  template: `<b0-page-header title="Check In History" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Check In History content"><pre>{{ state.data | json }}</pre></section> }
  }`,
