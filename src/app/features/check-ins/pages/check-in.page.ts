  ...
  template: `<mat-card class="max-w-2xl"
    ...
    <form [formGroup]="form" class="grid gap-3">
      ...
      ><mat-form-field
        ...
        ><textarea matInput maxlength="500" formControlName="note"></textarea></mat-form-field
      ><button mat-raised-button color="primary" [disabled]="form.invalid">Submit check-in</button>
    </form></mat-card
  >`,
