...
export class CapsuleService {
  ...
  start(capsuleId: string, idempotencyKey: string) {
    return this.#api.post<CapsuleStartResponse>(
      `/capsules/${encodeURIComponent(capsuleId)}/start`,
      {},
      {
  ...
  acknowledgeMemory(questionAttemptId: string) {
    return this.#api.post<void>(`/question-attempts/${questionAttemptId}/acknowledge-memory`, {});
  }
