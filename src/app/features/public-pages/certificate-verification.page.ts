...
@Component({
  ...
  template: `<b0-page-header title="Certificate Verification" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Certificate Verification content"><pre>{{ state.data | json }}</pre></section> }
  }`,
