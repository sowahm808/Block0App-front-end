...
@Component({
  ...
  template: `<b0-page-header title="Account Disabled" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Account Disabled content"><pre>{{ state.data | json }}</pre></section> }
  }`,
