...
@Component({
  ...
  template: `<b0-page-header title="Raffle Entries" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Raffle Entries content"><pre>{{ state.data | json }}</pre></section> }
  }`,
