...
@Component({
  ...
  template: `<b0-page-header title="Reward Card" description="Production component for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Reward Card content"><pre>{{ state.data | json }}</pre></section> }
  }`,
