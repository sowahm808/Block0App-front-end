...
{ path: 'learning-packs/import', data: { ...page('Import learning pack'), apiPath: '/admin/content/import-learning-pack' }, loadComponent: () => import('./pages/import-learning-pack.page').then(m => m.ImportLearningPackPage) },
