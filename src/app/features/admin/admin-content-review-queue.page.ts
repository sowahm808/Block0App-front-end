...
@Component({
  ...
  template: `<b0-page-header title="Admin Content Review Queue" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Admin Content Review Queue content"><pre>{{ state.data | json }}</pre></section> }
  }`,
