...
@Component({
  ...
  template: `<b0-page-header title="Admin Learning Pack List" description="Production page for Block Zero workflows." />
  @if (state$ | async; as state) {
    ...
    @else { <section class="feature-grid" tabindex="0" aria-label="Admin Learning Pack List content"><pre>{{ state.data | json }}</pre></section> }
  }`,
