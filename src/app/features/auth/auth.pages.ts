  ...
  template: `<mat-card class="mx-auto max-w-md"
    ...
    ><mat-card-content
      ><form [formGroup]="form" (ngSubmit)="submit()" class="grid gap-3">
        ...
        ><button mat-raised-button color="primary" [disabled]="form.invalid || busy">Login</button
...
@Component({
  ...
  template: `<mat-card class="mx-auto max-w-md"
    ...
    <form [formGroup]="form" (ngSubmit)="submit()" class="grid gap-3 p-4">
      <mat-form-field><mat-label>Name</mat-label><input matInput formControlName="displayName" /></mat-form-field
      ><mat-form-field><mat-label>Email</mat-label><input matInput formControlName="email" /></mat-form-field
      ><mat-form-field
        ><mat-label>Password</mat-label><input matInput type="password" formControlName="password" /></mat-form-field
