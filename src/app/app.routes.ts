  ...
  { path: 'server-error', loadComponent: () => import('./features/public-pages/server-error.page').then((m) => m.ServerErrorPage) },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canMatch: [roleMatchGuard],
        data: { roles: ['Scholar'] },
        loadChildren: () => import('./features/rehearsal/routes'),
      },
      ...
      { path: 'team', loadChildren: () => import('./features/teams/routes') },
      {
        ...
        canMatch: [roleMatchGuard],
        data: { roles: ['Scholar'] },
        loadChildren: () => import('./features/readiness/routes'),
      },
      {
        path: 'rewards',
        canMatch: [roleMatchGuard],
        data: { roles: ['Scholar'] },
        loadChildren: () => import('./features/rewards/routes'),
      },
      {
        path: 'raffle-entries',
        canMatch: [roleMatchGuard],
        data: { roles: ['Scholar'], title: 'Raffle entries', apiPath: '/raffle-entries' },
        loadComponent: () => import('./features/rewards/raffle-entries.page').then((m) => m.RaffleEntriesPage),
      },
      {
        path: 'certificates',
        canMatch: [roleMatchGuard],
        data: { roles: ['Scholar'] },
        loadChildren: () => import('./features/certificates/routes'),
      },
      ...
      {
        path: 'settings',
        data: { title: 'Settings', pageCategory: 'account', apiPath: '/profile' },
        loadComponent: () => import('./features/profile/settings.page').then((m) => m.SettingsPage),
      },
      {
        path: 'notification-preferences',
        data: { title: 'Notification preferences', pageCategory: 'account', apiPath: '/notification-preferences' },
        loadComponent: () =>
          import('./features/notifications/notification-preferences.page').then((m) => m.NotificationPreferencesPage),
      },
      {
        path: 'mentor',
        canMatch: [roleMatchGuard],
